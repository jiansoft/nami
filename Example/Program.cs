...
internal class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        now = now.AddSeconds(1);
        var fromTime = new TimeOnly(now.Hour, now.Minute, now.Second, now.Millisecond);
        ...
        Nami.EveryMonday().At(12, 0, 0).Do(() => { PrintData("EveryMonday().Days().At(12,0,0)   ", DateTime.Now); });
        ...
        Nami.Delay(1).Seconds().Times(5).Do(() => { Log.Info($"Nami.Delay(1).Seconds() {DateTime.Now:HH:mm:ss}"); });
        ...
        Nami.Every(60000).Milliseconds().Do(() => { PrintData("Just Every(60000).Milliseconds()   ", DateTime.Now); });
        ...
        Nami.Every(2).Minutes().At(0, 0, 15)
            .Do(() => { PrintData("Nami.Every(2).Minutes().At(0,0,15)", DateTime.Now); });
    ...
    {
        Log.Info($"{name} {date:yyyy-MM-dd HH:mm:ss.ffffff}");
    }
